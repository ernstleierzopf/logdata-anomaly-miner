"""This file defines the EnhancedNewMatchPathValueComboDetector. detector to
extract values from LogAtoms and check, if the value combination was already
seen before.
...
class EnhancedNewMatchPathValueComboDetector(NewMatchPathValueComboDetector):
    ...
    of match data paths were found. It is similar to the
    NewMatchPathValueComboDetector basic detector but also provides support for
    storing meta information about each.
